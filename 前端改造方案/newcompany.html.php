...
<head>
	...
	<link rel="stylesheet" type="text/css" href="//cdn.{ROOT_DOMAIN}/css/front.css?v=20150428" />
	<link rel="stylesheet" type="text/css" href="//cdn.{ROOT_DOMAIN}/css/job.css?v=20150226" />
	<link rel="stylesheet" type="text/css" href="//cdn.{ROOT_DOMAIN}/css/jobnew.css?v=201504286" />
	<link rel="stylesheet" type="text/css" href="//cdn.{ROOT_DOMAIN}/css/mainPhoto.css?v=20150829" />
	<link rel="stylesheet" type="text/css" href="//cdn.{ROOT_DOMAIN}/css/map.css?v=100713305" />
	...
	<style id="depNav">
		...
		.tabpanel_tab_content .tabpanel_left_scroll {
			...
			height: 36px;
			cursor: pointer;
			background: transparent url(//public.tzrl.com/images/new/scroll.gif) no-repeat -15px 0;
		}
		...
		.tabpanel_tab_content .tabpanel_right_scroll {
			...
			height: 36px;
			cursor: pointer;
			background: transparent url(//public.tzrl.com/images/new/scroll.gif) no-repeat -30px 0;
		}
	...
	<![endif]–>
	<!--<script type="text/javascript" language="javascript" src="//cdn.{ROOT_DOMAIN}/js/jquery-1.8.3.js?v=20150226"></script>-->
	<script type="text/javascript" language="javascript" src="//cdn.{ROOT_DOMAIN}/js/jquery-1.8.3.min.js?v=20171221"></script>

	<!--<script type="text/javascript" language="javascript" src="//cdn.{ROOT_DOMAIN}/js/common.js?v=20150227"></script>-->

	<!--cny_flag_begin-->
	<script type="text/javascript" language="javascript" src="//cdn.{ROOT_DOMAIN}/js/dialog.js?v=20150226"></script>
	<script type="text/javascript" language="javascript" src="//cdn.{ROOT_DOMAIN}/js/jquery.form.js?v=20150226"></script>
	<script type="text/javascript" language="javascript" src="//cdn.{ROOT_DOMAIN}/js/ui_validate.js?v=20150226"></script>
	<script type="text/javascript" language="javascript" src="//cdn.{ROOT_DOMAIN}/js/ui_inputFocus.js?v=20150226"></script>
	...
	<script type="text/javascript">
		// jpjs.loadJS('//cdn1.597.com/min/js/v2/common.js');//好像没用
	</script>
	<!--cny_flag_end-->
</head>
<body>
	...
	<div class="banner" id="banner">
		<div class="lst flexslider2">
			...
			<!--{loop $imageCachesArr $l}-->
				<li style="background:url(//cdn.{ROOT_DOMAIN}/img/common/loadBox.gif) no-repeat center center">
					<!--{if $l['isUpload']==1}-->
						<img rel="//pic.{ROOT_DOMAIN}/companyTemplate/{$l['name']}" />
					<!--{else}-->
						<img rel="//cdn.{ROOT_DOMAIN}/img/templates/{$l['name']}" />
					<!--{/if}-->
				</li>
			<!-- <script type="text/javascript">

					&lt;!&ndash;{if $l['isUpload']==1}&ndash;&gt;
						bannerImgs.push("//pic.{ROOT_DOMAIN}/companyTemplate/{$l['name']}");
					&lt;!&ndash;{else}&ndash;&gt;
						bannerImgs.push("//cdn.{ROOT_DOMAIN}/img/templates/{$l['name']}");
					&lt;!&ndash;{/if}&ndash;&gt;
				</script>-->
			<!--{/loop}-->
			</ul>
	...
	<div class="njmName shadow">
		<div class="njmName01">
			<div class="njmNameImg">
				<div class="njmNameMge">
					<div class="njmNameXbox">
						<p>
							<!--{if $com['logoUrl']}-->
								<img src="//pic.{ROOT_DOMAIN}/logo/{$com[logoUrl]}">
							<!--{else}-->
								<img src="//cdn.{ROOT_DOMAIN}/img/job/newjob/default_logo.png" />
							<!--{/if}-->
						</p>
					</div>
				</div>
			...
			<div class="njmNameRt">
				...
				<span>
					...
					<!--{else}-->
					<img src="//cdn.{ROOT_DOMAIN}/img/job/newjob/newjob_100.png" width="15" height="18" />
					<!--{/if}-->
				</span>
				<!--{if $com['comStr']}-->
				<p class="njmNametit2">
				...
				<div class="dressUp" id="dressUp">
					<img src="//cdn.{ROOT_DOMAIN}/img/job/newjob/newJob_78.png" width="171" height="40" />
		...
		<div class="njmNameFcs">
			<div class="nFcswin" style='display:none'>
				<span>关注成功</span>
				<img src="//cdn.{ROOT_DOMAIN}/img/job/newjob/newjob_65.png" width="8" height="26" />
			</div>
			<!------关注成功用awareBtn------>
			<!--{if $isFan}-->
		...
		<div class="nJobMainCont">
			<div class="main" style="width: 100%;">
				<div class="main_left">
								...
								<div class="infopic">
									<div class="picbox">
										<ul class="gallery piclist">
											<!--{loop $resPic $l}-->
											<li style="background:url(//cdn.{ROOT_DOMAIN}/img/common/loadBox.gif) no-repeat center center">
												<a href="//pic.{ROOT_DOMAIN}/com/{$l[picPath]}" rel="prettyPhoto[]">
													<img rel="//pic.{ROOT_DOMAIN}/com/{$l[picPath]}"/>
												</a>
												<!--<script type="text/javascript">
													phoneImgs.push("//pic.{ROOT_DOMAIN}/com/{$l[picPath]}");
												</script>-->
											</li>
											<!--{/loop}-->
										</ul>
                            ...
                            <div class="comPhotos">
                                <ul id="focus" style="height: 290px;">
                                    ...
                                    <li   style="&lt;!&ndash;{if $k>0}&ndash;&gt;display:none;&lt;!&ndash;{/if}&ndash;&gt;">
                                        <a href="//pic.{ROOT_DOMAIN}/com/{$l[picPath]}" rel="prettyPhoto[]">
                                            <img src="//pic.{ROOT_DOMAIN}/com/{$l[picPath]}" alt="" />
                                        </a>
                                    </li>
                                    &lt;!&ndash;{/loop}&ndash;&gt;
                                </ul>
								...
								<!--全部职位-->
									...
									<li rel="{$l['cuid']}" class="job_li"><a style="padding:10px;" href="/job-{$l['_jid']}.html" target="_blank" title="{$l['jname']}">
										<h6 >
											...
											<!--{if $l['urgency']==1}-->
												<span class="ji" >
													<!--<img src="//cdn.{ROOT_DOMAIN}/www/images/rocket.png" alt=""/>-->
													急
												</span>
												<!--{/if}-->
												{$l['jname']}
					...
					<div class="newTytit shadow" id="comMap">
						...
						<p class="njmTit2">
							...
							<!--{/if}-->
							<!--<a target='_blank' href="//api.map.baidu.com/geocoder?address={$com['comAddress']}&output=html">查看地图</a>-->
				...
				<div class="main_right" style="width: 260px;float: right;">
					...
					<!--{/if}-->
					<a class="right_adv" target="_blank" href="/ke/category.html"><img  style="" src="//cdn.{ROOT_DOMAIN}/www/images/yun_class.png" alt=""/></a>
					<a class="right_adv" target="_blank" href="/download/app/"><img  style="" src="//cdn.{ROOT_DOMAIN}/www/images/app_load_a.png" alt=""/></a>
					<!--
...
<script type="text/javascript" src="//cdn.{ROOT_DOMAIN}/js/baiduMap.js?v=1"></script>
...
<!--个性装扮轮播图 begin-->
<script src="//cdn.{ROOT_DOMAIN}/www/js/jquery.flexslider.js" language="javascript"></script>
<script src="//cdn.{ROOT_DOMAIN}/www/js/jquery.imageCrop.js" language="javascript"></script>
<script src="//cdn.{ROOT_DOMAIN}/www/js/jquery.fileUploader.js" language="javascript"></script>
<!--依赖jquery.imageCrop.js\jquery.fileUploader.js-->
<script src="//cdn.{ROOT_DOMAIN}/www/js/jquery.imageEditor.js" language="javascript"></script>
<script type="text/javascript">
        ...
        uploadDialog.after('show',function(){
            ...
            if(!imgEditor){
                ...
                imgEditor = $.imageEditor({
                    ...
                    fileUploaderConfig: {
                        imageURL: '//pic.{ROOT_DOMAIN}/companyTemplate/'
                    },
...
<!--职位列表效果 begin-->
<!--{if $jobCount}-->
<script src="//cdn.{ROOT_DOMAIN}/js/fader.js" language="javascript"></script>
<script src="//cdn.{ROOT_DOMAIN}/js/tab.js" language="javascript"></script>
<script>
    /**
     * 职位列表效果(按部门)
     */
...
<script src="//cdn.{ROOT_DOMAIN}/www/js/jquery.jobPrettyPhoto.js" language="javascript"></script>
<script type="text/javascript">
    // jpjs.use('@jobPrettyPhoto, @imgLoader', function(m){
    (function(){
        var /*$ = m['jpjob.jobPrettyPhoto'],*/
...
<script src="//cdn.{ROOT_DOMAIN}/js/ScrollText.js" language="javascript"></script>
<script>
    /*底部公告（上上滚动效果）*/
    (function () {
