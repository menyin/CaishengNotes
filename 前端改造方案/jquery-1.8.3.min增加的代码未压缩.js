    ...
    (function(){
        ...
        e.util=(function(){
            ...
            exports.array = {
                 ...
                 * ���������
                 * @param arr {array} �������
                 * @returns {function} �ȽϺ��� function(value,i,arr){}
                 * @returns {obj} �ȽϺ�����this����
                 * @returns {array} ���˺������
                 */
                filter :  Array.prototype.filter ? function(arr, fn, scope){
                ...
                indexOf: Array.prototype.indexOf ? function(el, arr){
        ...
        e.aspect=(function(){
            ...
            function aop(status, methodName, callback){
                ...
                while(name = names.shift()){
                    method = this[name];
                    if(!method){
                        throw new Error('base.aspect: ��Ч����[' + methodName + ']');
                    }
                    if(!method._isAop){
                        wrap.call(this, name);
                    }
        ...
        e.Class=(function(){
            ...
            Class.extend = function(o){
                if(!checkContext(this))
                    throw new Error('class.extends: ���������Ͳ�����');
                return util.extend(this, o);
            }
            Class.implement = function(items){
                if(!checkContext(this))
                    throw new Error('class.implement: ���������Ͳ�����');
            ...
            Class.parent = function(method){
                if( !checkContext(this) )
                    throw new Error('class.parent: ���������Ͳ�����');
                if( !this.superclass )
                    throw new Error('class.parent: �Ҳ�������');
